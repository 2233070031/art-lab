<template>
    ...
    <n-scrollbar x-scrollable trigger="hover">
      <el-table :data="tableData" border style="width: 100%" row-key="id" height="770">
        <el-table-column prop="oplanPatientId" label="ART号" width="240" align="center"/>
        <el-table-column prop="nameW" label="女方姓名" width="240" align="center"/>
        <el-table-column prop="ageW" label="女方年龄" width="240" align="center"/>
        <el-table-column prop="nameM" label="男方姓名" width="240" align="center"/>
        <el-table-column prop="ageM" label="男方年龄" width="240" align="center"/>
        <el-table-column prop="ageM" label="周期类型" width="230" align="center"/>
        <el-table-column prop="sourceSemen" label="精液来源" width="240" align="center"/>
      </el-table>
    </n-scrollbar>
  </div>
</template>
...
function onSubmit() {
  getSperm({operationDate: formInline.searchDate}).then(data => {
    // console.log(data)
